...
<nav >
    <ul>
        ...
        <li>Nosotros</li>
        <li><a id="hiper" href="/mvcframe/index.php">Editar</a></li>
...
Swal.fire({
    ...
    text: 'Los ingresos son contenido y competencía dependiendo de su necesidad',
    icon: 'success',
    showCancelButton: true,
    confirmButtonColor: '#3085d6',
    cancelButtonColor: '#d33',
    confirmButtonText: 'Competencía',
    cancelButtonText: 'Contenido'
 }).then(function(result) {
   if (result.isConfirmed) {
     location.assign("/mvcframe/vista/competencia.php")
   }
   else{
    location.assign("/mvcframe/vista/contenido.php")
   }
 });
 </script>
<?php
