...
?>
    ...
    <div class="container">
        ...
        <form method="POST" autocomplete="off" id="formulario" name="formulariocompete" action="mostrar.php" >   <!--Target es el tipo de información de respuestas-->
        
            <fieldset>  <!-- Vamos a agregar un marco-->

            <legend>Datos competencias: </legend>
            
                <div class="mb-3">
                    <label for="idComp" class="laiden">Identificador de competencia: </label> <br/>
                    <input type="text" id="idComp" name="idCompetencia"  required="true" placeholder="Ingrese id de competencía"/><br/>
                </div>

                <label for="hasvideoresource">VideoRecursoAsociado</label><br/>
                <input type="text" id="idhasvideoresource1" name="hasvideoresource1" placeholder="Ingrese el identificador del video recurso asociado a la competencía" required="true">
                <!--<div id="parentDiv">--->
                <a href="#" onclick="addobjects1.anadirobject(0);">Añadir campo </a>
                <a href="#" onclick="addobjects1.deleteobject(0);">Eliminar campo </a>
                <div id="addhasvideore"></div></br>
                <!--</div>-->

                <div class="mb-3">                
                <label for="Descripcion ">Descripción: </label> <br/> 
                <textarea type="text" id="Descripcion" name="Descripcion" placeholder="Escribe la descripción de la competencía "/ rows="3" required="true"></textarea><br/>
                </div>

                <label for="Evidencias" id="evi">Evidencias de aprendizaje</label><br/>
                <input type="text" id="idevi1" name="Evidencia1" placeholder="Ingrese la evidencia de aprendizaje" required="true">
                <!--<div id="parentDiv">--->
                <a href="#" onclick="addobjects1.anadirobject(1);">Añadir campo </a>
                <a href="#" onclick="addobjects1.deleteobject(1);">Eliminar campo </a>
                <div id="addevi"></div></br>
                <!--</div>-->
        
                <label for="Temas">Temas</label><br/>
                <input type="text" id="Topic1" name="Topic1" placeholder="Ingrese el topic" required="true">
                <!--<div id="parentDiv">--->
                <a href="#" onclick="addobjects1.anadirobject(2);">Añadir campo </a>
                <a href="#" onclick="addobjects1.deleteobject(2);">Eliminar campo </a>
                 <div id="addtopic"></div></br>
                <!--</div>-->
                

                <label for="Edad">Edad Tipica</label><br/>
                <input type="number" id="Edad" name="Edad" placeholder="Ingrese la edad tipica" required="true"></br>
        
                <label for="Keywords">Keywords</label><br/>
                <input type="text" id="idkey1" name="keyword1"  placeholder="Ingrese la palabra clave(s)" required="true">
                <!--<div id="parentDiv">--->
                <a href="#" onclick="addobjects1.anadirobject(3);">Añadir campo </a>

                <a href="#" onclick="addobjects1.deleteobject(3);">Eliminar campo </a>
                <div id="addkey"></div></br>

                <label for="Grade">Grado</label><br/>
                <input type="number" id="Grade"  name="Grade" placeholder="Ingrese el grado de la competencía" required="true"><br/>
                ...
                <button  class='btn btn-primary mb-3' id="enviar" onclick="finalizar1.finalizarcomp();">Enviar</button>
    ...
    class generateInputs{
        ...
        add(key,field){
            ...
            if(key=="idhasvideoresource"){
                campo="Ingrese el identificador del video recurso asociado a la competencia";
            }
            if(key=="idevi"){
                campo="Ingrese la evidencia de aprendizaje";
            }
            if(key=="topic"){
                campo="Ingrese el topic";
            }
            if(key=="ideky"){
                campo="Ingrese la palabra clave";
            }
...
this.writeComment("Definición de ObjectProperty");
    ...
    this.writeEndElement();//Cierra la adicción del nodo hijo.
     ...
     this.writeComment("Definición de Dataproperty");
    ...
    this.writeEndElement();
     ...
     this.writeComment("Definición de clases");
    ...
    //definición de individuos
		...
		this.writeStartElement( "owl:NamedIndividual");
         ...
         this.writeAttributeString("rdf:about","http://www.semanticweb.org/VLRF/VLRF_KB#"+ formulario['idComp'].value); //Obtiene el valor del id competencía.
            ...
            let formuhasvide1=formulario['idhasvideoresource1'].value;
           
            
			if(formuhasvide1.indexOf("&")>0){
                    
                    let newcadena=formuhasvide1.slice(0,formuhasvide1.indexOf("&"));
                    console.log(newcadena);
                    this.writeStartElement('hasVideoResource rdf:resource="http://www.semanticweb.org/VLRF/VLRF_KB#'+newcadena +'"');
			   this.writeEndElement();
                }
                
                else{
               this.writeStartElement('hasVideoResource rdf:resource="http://www.semanticweb.org/VLRF/VLRF_KB#'+formuhasvide1 +'"');
			   this.writeEndElement();
            ...
            for(let i=0;i<addobjects.objetoidhasvideoresource.length;i++){
                ...
                let formuhasvide=formulario[addobjects.objetoidhasvideoresource[i].mostrarobjeto()].value;
                
                if(formuhasvide.indexOf("&")>0){
                    
                    let newcadena=formuhasvide.slice(0,formuhasvide.indexOf("&"));
                    console.log(newcadena);
                    this.writeStartElement('hasVideoResource rdf:resource="http://www.semanticweb.org/VLRF/VLRF_KB#'+newcadena +'"');
			   this.writeEndElement();
                }
               ...
               this.writeStartElement('hasVideoResource rdf:resource="http://www.semanticweb.org/VLRF/VLRF_KB#'+formuhasvide +'"');
			   this.writeEndElement();
...
//xw.writeDocType('"items.dtd"');
        ...
        this.writeAttributeString("rdf:about","http://www.semanticweb.org/VLRF/VLRF_KB#"+ formulariocontenido['Identificador'].value);
        ...
        "Nov", "Dec"
           ...
           let data = formulariocontenido['datecont'].value;
            ...
            this.writeAttributeString("rdf:datatype","http://www.w3.org/2001/XMLSchema#anyURI");
            this.writeString(formulariocontenido['url'].value);
            this.writeEndElement();
