...
*/
//echo $_POST['varhidden'];
$previous = "javascript:history.go(-1)";

if($_POST['varhiddenerror']==1){
echo "<html><head></head>".
"<body onload=\"history.back()\">".    // Retornar a la pagina anterior si los valores no son correctos.
"<script>"."alert('No se pudo subir al servidor')"."</script>".
"</body></html>";
exit;
echo $_POST['varhiddenerror'];
header("location:blank2.html");
}


if($_POST['varhidden']==1){
echo "<html><head></head>".
"<body onload=\"history.back()\">".    // Retornar a la pagina anterior si los valores no son correctos.
"</body></html>";
exit;
echo $_POST['varhidden'];
    ...
    //'<script language="javascript">window.location.href="blank.html";</script>';
}
